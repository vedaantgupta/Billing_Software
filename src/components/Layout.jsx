...
import { LayoutDashboard, Users, FileText, Package, BarChart3, Settings as SettingsIcon, Bell, Search, LogOut, CreditCard, ChevronDown, ChevronRight, UserCog } from 'lucide-react';
import './Layout.css';
      ...
      <div className="main-content">
        <header className="topbar glass">
          <div className="search-bar">
            <Search size={18} style={{ color: 'var(--text-secondary)', marginLeft: '10px', position: 'absolute' }} />
            <input type="text" className="search-input" placeholder="Search invoices, products..." style={{ paddingLeft: '35px' }} />
          </div>
